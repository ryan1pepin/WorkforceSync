...
public sealed class AtomFeedParser
{
    ...
    private static WorkforceEvent ParseEntry(XElement entry)
    {
        ...
        return new WorkforceEvent(
            ...
            PersonNumber: ElementValue(eventEl, "personNumber"),
            FirstName: ElementValue(eventEl, "firstName"),
            LastName: ElementValue(eventEl, "lastName"),
            Email: ElementValue(eventEl, "email"),
            LegalEmployer: ElementValue(eventEl, "legalEmployer"),
            PositionId: ElementValue(eventEl, "positionId"),
            Job: ElementValue(eventEl, "job"),
            Grade: ElementValue(eventEl, "grade"),
            JobTitle: ElementValue(eventEl, "jobTitle"),
            Department: ElementValue(eventEl, "department"),
            WorkLocation: ElementValue(eventEl, "workLocation"),
            Supervisor: ElementValue(eventEl, "supervisor"),
            EmploymentType: ElementValue(eventEl, "employmentType"),
            PayBasis: ElementValue(eventEl, "payBasis"),
            ...
            TerminationReason: ElementValue(eventEl, "terminationReason"),
